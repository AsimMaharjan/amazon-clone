    ...
    cartItems.forEach((item)=>{
        ...
        <div class="cart-item flex items-center pb-4 border-b border-gray-100">
                        ...
                        <div class="cart-item-total-cost w-48 font-bold text-gray-400">
                            <h4> ${numeral(item.price * item.quantity).format('$0,0.00')}</h4>
                        </div>
                        <div  data-id="${item.id}"  class="cart-item-delete text-gray-400 font-bold w-10 cursor-pointer hover:text-gray-700">
