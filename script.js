...
function generateItems(items){
    ...
    addToCart.classList.add("h-8", "w-28", "bg-yellow-500","flex", "justify-center", "items-center", "rounded", "cursor-pointer","hover:bg-yellow-700", "text-white", "text-md");
